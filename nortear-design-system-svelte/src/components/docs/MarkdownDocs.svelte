...
<DocsPageLayout navGroups={NAV_GROUPS} activeSection={section.value}>
  ...
  <DocsRelated
    ...
    items={[
      { name: $tStore('related.items.codeBlock.name'), description: toPlainText($tStore('related.items.codeBlock.description')), path: '?path=/docs/ui-codeblock--docs' },
      ...
      { name: $tStore('related.items.table.name'),     description: toPlainText($tStore('related.items.table.description')),     path: '?path=/docs/ui-table--docs' },
