        ...
        {#each pairs as pair, i (i)}
          <div class="nds-grid" data-cols="2" data-spacing="lg">
            ...
            <div class="nds-stack" data-spacing="sm">
              ...
              <Card class="nds-cluster nds-shadow-none nds-p-4" data-justify="center" data-docs-preview="do">
            ...
            <div class="nds-stack" data-spacing="sm">
              ...
              <Card class="nds-cluster nds-shadow-none nds-p-4" data-justify="center" data-docs-preview="dont">
