...
import ConnectionStateStory from './ConnectionStateStory.svelte';
...
import ConnectionStateDocs from '@/components/docs/ConnectionStateDocs.svelte';
...
const meta: Meta<PlaygroundArgs> = {
  ...
  component: ConnectionStateStory,
