...
import { activityGraphLabels } from './activity-graph.fixtures';
...
import ActivityGraphDocs from '@/components/docs/ActivityGraphDocs.svelte';
 ...
 * se a grade tem tinta — e não se ela existe, que é a diferença desta peça em
 * relação às irmãs da família; e o começo da semana gira as sete linhas.
 *
 ...
 * que muda SEM trocar o período — e, entre eles, o que a atividade vazia
...
export const Playground: Story = {
  ...
  // O invólucro é quem transforma `withActivity` em `days`: a peça não sabe o
  // que é um booleano de atividade, só sabe uma lista de dias.
  render: (args) => ({
    Component: ActivityGraphStory,
    props: { ...args, testid: 'activity-graph-host' },
  }),
