...
import FlowGraphDocs from '@/components/docs/FlowGraphDocs.svelte';
...
export const Playground: Story = {
  ...
  // dado — a fatia da lista e a lista vazia de ligações. Traduzir aqui deixaria
  // o painel Code e a foto lendo duas contas diferentes do mesmo controle.
  render: (args) => ({
    Component: FlowGraphStory,
    props: { ...args, testid: 'flow-graph-host' },
  }),
