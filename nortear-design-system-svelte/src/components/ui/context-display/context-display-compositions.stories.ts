...
import ContextDisplayBesideFieldStory from './ContextDisplayBesideFieldStory.svelte';
...
export const BesideField: Story = {
  ...
  render: () => ({
    Component: ContextDisplayBesideFieldStory,
  ...
  play: async ({ canvasElement, step }) => {
    ...
    await step('Nada no campo sabe que ela existe', async () => {
      ...
      await expect(describedBy).not.toContain(block);
