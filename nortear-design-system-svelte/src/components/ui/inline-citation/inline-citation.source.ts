...
export function inlineCitationInSentenceSource(): string {
  return svelteSnippet(
    [
      ...
      SENTENCE_PARTS,
      '',
      '// O RÓTULO É POR MARCA, porque o número entra nele: a marca não se',
      '// numera sozinha, e quem conhece a lista de fontes do turno é quem monta',
      '// a frase.',
      'function rotuloDe(indice, citation) { /* os rótulos daquela marca */ }',
      '',
