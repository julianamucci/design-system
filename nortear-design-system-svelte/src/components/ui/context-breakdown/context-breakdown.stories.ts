...
import ContextBreakdownStory from './ContextBreakdownStory.svelte';
...
import ContextBreakdownDocs from '@/components/docs/ContextBreakdownDocs.svelte';
...
const meta: Meta<PlaygroundArgs> = {
  ...
  component: ContextBreakdownStory,
