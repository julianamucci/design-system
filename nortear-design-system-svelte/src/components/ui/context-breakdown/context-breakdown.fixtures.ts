...
import type { ContextBreakdownLabels } from './index';
 ...
 * que a play procura é sempre o que a repartição desenha.
 */
export function contextBreakdownLabels(): ContextBreakdownLabels {
  return contextBreakdownLabelsFor(get(locale));
}
...
/** A variação sem uma palavra, no idioma corrente. */
