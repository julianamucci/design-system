...
import TerminalBlockStory from './TerminalBlockStory.svelte';
...
import TerminalBlockDocs from '@/components/docs/TerminalBlockDocs.svelte';
...
export const Playground: Story = {
  ...
  render: (args) => ({ Component: TerminalBlockStory, props: { ...args } }),
