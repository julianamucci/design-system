...
import {
  designEscreve, designTextsOutsideLegend, designTexts, distinctShapes, isPainted, pointerOver, exigirRoot, settleTheme, tokenColor, waitForStableCount,
...
const meta: Meta = {
  ...
  title: 'Components/Display/Chart/Variants',
