 ...
 * vigor, e volta a reaplicá-los quando a classe do documento muda. Existem
 * para que um option montado e usado FORA do container ainda desenhe um rótulo
 * legível — `currentColor` herda do documento, e a placa transparente faz o
 * pior caso virar "sem placa" em vez de "texto invisível".
 */
