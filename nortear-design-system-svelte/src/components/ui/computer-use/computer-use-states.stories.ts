...
import ComputerUseEveryStatusStory from './ComputerUseEveryStatusStory.svelte';
import { computerUseLabels } from './computer-use.fixtures';
import {
...
type EveryStatusStory = StoryObj<typeof ComputerUseEveryStatusStory>;
...
export const Running: Story = {
  ...
  render: () => ({
    ...
    props: { status: 'running', activeIndex: 3 },
  }),
  play: async ({ canvasElement, step }) => {
...
export const Finished: Story = {
  ...
  render: () => ({
    Component: ComputerUseStory,
    props: { status: 'complete', activeIndex: COMPUTER_STEPS_LOGIN.length - 1 },
  }),
  play: async ({ canvasElement, step }) => {
    const piece = pieceOf(canvasElement);
...
export const FirstStep: Story = {
  ...
  render: () => ({
    Component: ComputerUseStory,
    props: { status: 'running', activeIndex: 0, steps: COMPUTER_STEPS_SHORT },
  }),
  play: async ({ canvasElement, step }) => {
    const piece = pieceOf(canvasElement);
...
export const WithoutSteps: Story = {
  ...
  render: () => ({
    Component: ComputerUseStory,
    props: { status: 'idle', activeIndex: 0, withSteps: false },
  }),
  play: async ({ canvasElement, step }) => {
    const piece = pieceOf(canvasElement);
...
export const ClampedIndex: Story = {
  ...
  render: () => ({
    Component: ComputerUseStory,
    props: { status: 'complete', activeIndex: 99 },
  }),
  play: async ({ canvasElement, step }) => {
    const piece = pieceOf(canvasElement);
