...
// media. Os sandboxes (`src/App.*`, `src/main.*`, `src/app.ts`) foram removidos
// das quatro stacks de navegador — o angular nunca teve — e sem arquivo a regra
// devolveria `[]` para sempre. Lista vazia por AUSÊNCIA é indistinguível de
// lista vazia por limpeza, que é o erro de leitura que `slug_inexistente`
