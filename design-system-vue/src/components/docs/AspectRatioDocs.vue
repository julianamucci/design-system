  ...
  <DocsPageLayout :nav-groups="navGroups" :active-section="activeSection">
    ...
    <DocsDemonstration :title="tContent('demonstration.title')">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
        <div class="space-y-2">
          <AspectRatio :ratio="16 / 9">
            <img :src="imgLandscape" :alt="tContent('demonstration.labels.sixteenNine')" class="h-full w-full object-cover rounded-md" />
          </AspectRatio>
          <p class="text-xs text-muted-foreground">{{ tContent('demonstration.labels.sixteenNine') }}</p>
        </div>
        <div class="space-y-2">
          <AspectRatio :ratio="4 / 3">
            <img :src="imgProduct" :alt="tContent('demonstration.labels.fourThree')" class="h-full w-full object-cover rounded-md" />
          </AspectRatio>
          <p class="text-xs text-muted-foreground">{{ tContent('demonstration.labels.fourThree') }}</p>
        </div>
        <div class="space-y-2">
          <AspectRatio :ratio="1">
            <img :src="imgAvatar" :alt="tContent('demonstration.labels.square')" class="h-full w-full object-cover rounded-md" />
          </AspectRatio>
          <p class="text-xs text-muted-foreground">{{ tContent('demonstration.labels.square') }}</p>
        </div>
        <div class="space-y-2">
          <AspectRatio :ratio="3 / 4">
            <img :src="imgPortrait" :alt="tContent('demonstration.labels.threeFour')" class="h-full w-full object-cover rounded-md" />
          </AspectRatio>
    ...
    >
      <template #do-preview-0>
        <AspectRatio :ratio="16 / 9" class="w-full">
          <img :src="imgLandscape" alt="Paisagem" class="h-full w-full object-cover rounded-md" />
        </AspectRatio>
      </template>
      <template #dont-preview-0>
        <AspectRatio :ratio="16 / 9" class="w-full bg-muted">
          <img :src="imgLandscape" alt="Paisagem" class="h-full w-full object-contain rounded-md" />
        </AspectRatio>
      </template>
      <template #do-preview-1>
        <AspectRatio :ratio="4 / 3" class="w-full">
          <img :src="imgProduct" alt="Produto" class="h-full w-full object-cover rounded-md" />
        </AspectRatio>
      </template>
      <template #dont-preview-1>
        <AspectRatio :ratio="4 / 3" class="w-full rounded-md border">
          <img :src="imgProduct" alt="Produto" class="h-full w-full object-cover" />
        </AspectRatio>
      </template>
    </DocsDoDont>
    ...
    <DocsVariants :title="tContent('variants.title')" :items="variantItems">
      <template #variant-preview-0>
        <AspectRatio :ratio="16 / 9" class="w-full">
          <img :src="imgLandscape" alt="Paisagem 16:9" class="h-full w-full object-cover rounded-md" />
        </AspectRatio>
      </template>
      <template #variant-preview-1>
        <AspectRatio :ratio="4 / 3" class="w-full">
          <img :src="imgProduct" alt="Produto 4:3" class="h-full w-full object-cover rounded-md" />
        </AspectRatio>
      </template>
      <template #variant-preview-2>
        <AspectRatio :ratio="1" class="w-full">
          <img :src="imgAvatar" alt="Avatar 1:1" class="h-full w-full object-cover rounded-md" />
        </AspectRatio>
      </template>
      <template #variant-preview-3>
        <AspectRatio :ratio="3 / 4" class="w-full">
          <img :src="imgPortrait" alt="Retrato 3:4" class="h-full w-full object-cover rounded-md" />
        </AspectRatio>
      </template>
      <template #variant-preview-4>
        <AspectRatio :ratio="21 / 9" class="w-full">
          <img :src="imgUltraWide" alt="Ultra-wide 21:9" class="h-full w-full object-cover rounded-md" />
        </AspectRatio>
      </template>
    </DocsVariants>
