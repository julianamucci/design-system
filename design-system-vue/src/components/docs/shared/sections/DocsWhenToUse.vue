            ...
            <Table>
              <TableHeader>
                <TableRow class="border-b border-border bg-muted/70 text-left">
                  ...
                  <TableHead v-if="uxWriting.cols.rules" class="p-3font-semibold">{{ uxWriting.cols.rules }}</TableHead>
              ...
              <TableBody>
                <TableRow v-for="(row, i) in uxWriting.items" :key="i" class="border-b border-border last:border-0 hover:bg-muted/5">
                  ...
                  <TableCell v-if="uxWriting!.cols.rules" class="p-3text-muted-foreground">{{ row.rules }}</TableCell>
