    ...
    <div class="space-y-8">
      ...
      <div class="space-y-3">
        ...
        <div class="rounded-lg border border-border p-4 shadow-sm overflow-x-auto">
          <table class="w-full text-sm">
            ...
            <tbody>
              <tr v-for="(item, i) in functional.items" :key="i" class="border-b border-border last:border-0 hover:bg-muted/5">
                ...
                <td class="p-3 font-medium" :class="priorityClass(item.priority)">{{ item.priority }}</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div class="space-y-3">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div v-for="(item, i) in accessibility.items" :key="i" class="border rounded-lg p-3 bg-muted/30 space-y-1">
      ...
      <div class="space-y-3">
        ...
        <div class="rounded-lg border border-border p-4 shadow-sm overflow-x-auto">
          <table class="w-full text-sm">
            ...
            <tbody>
              <tr v-for="(item, i) in visual.items" :key="i" class="border-b border-border last:border-0 hover:bg-muted/5">
