...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Composições reais de NavigationMenu: LinkSimples (sem dropdown), ComDropdown (lista vertical), MegaMenuGrid (grid 2 colunas) e ComCardDestacado (card promocional + lista).',
      },
    },
  },
