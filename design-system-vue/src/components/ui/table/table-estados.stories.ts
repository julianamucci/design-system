    ...
    template: `
      <div style="max-width: 400px">
        <Table>
          ...
          <TableBody>
            <TableRow>
              <TableCell class="font-medium whitespace-nowrap">INV001</TableCell>
              <TableCell class="whitespace-nowrap">Pago</TableCell>
              <TableCell class="whitespace-nowrap">Cartão de crédito</TableCell>
              <TableCell class="whitespace-nowrap">12/04/2026</TableCell>
              <TableCell class="whitespace-nowrap">Empresa Alpha Ltda</TableCell>
              <TableCell class="text-right whitespace-nowrap">R$ 2.500,00</TableCell>
            </TableRow>
            <TableRow>
              <TableCell class="font-medium whitespace-nowrap">INV002</TableCell>
              <TableCell class="whitespace-nowrap">Pendente</TableCell>
              <TableCell class="whitespace-nowrap">Transferência bancária</TableCell>
              <TableCell class="whitespace-nowrap">13/04/2026</TableCell>
              <TableCell class="whitespace-nowrap">Fornecedor Beta S.A.</TableCell>
              <TableCell class="text-right whitespace-nowrap">R$ 1.150,00</TableCell>
            </TableRow>
          </TableBody>
        </Table>
      </div>
