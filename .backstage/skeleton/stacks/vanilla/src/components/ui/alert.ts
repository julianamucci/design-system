...
export function createAlertDescription(options: AlertDescriptionOptions = {}): HTMLElement {
  ...
  // PATCH: a11y — basecoat-css aplica `col-start-2` no grid via seletor `> section`. Com <div> a descrição cai na col 1 (16px, coluna do ícone) e o texto quebra letra a letra. (ver PATCHES.md#vanillaalert--descrio-como-section-para-grid-do-basecoat-css)
