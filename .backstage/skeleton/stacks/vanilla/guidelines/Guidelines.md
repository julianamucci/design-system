# Documentação do Design System — Guidelines (Vanilla)
...
### 1. Fundamentos (Vanilla — Vanilla TS)

- **[01-regras-gerais.md](./01-regras-gerais.md)** — Regras gerais obrigatórias do projeto Vanilla (funções TypeScript, DOM, lucide vanilla)
...
### 2. Componentes por Categoria (Vanilla / Vanilla TS)
...
### 4. Arquitetura e Design Sistema (Vanilla)
...
2. Consulte as **guidelines Vanilla** deste diretório para regras específicas de Vanilla TS e DOM
...
1. **Regras Gerais** (01) — Aplicam-se a todo o projeto Vanilla
...
- Se a regra é específica do Vanilla/Vanilla TS → adicionar neste diretório
