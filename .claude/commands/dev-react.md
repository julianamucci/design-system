...
1. **`_dev-shared.md`** (`.claude/commands/_dev-shared.md`) — padrões compartilhados das 5 stacks (regras, 15 seções, SEO, audits, checklist). **Esta skill complementa com o que é específico de React.**
