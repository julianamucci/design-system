...
* **É OBRIGATÓRIO que o anel use `--ring` com a cor cheia** — nunca com opacidade (`/50`, `/30`), que derruba o contraste do indicador de foco abaixo do exigido (WCAG 2.4.11)
