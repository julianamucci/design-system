...
import { DocsVariants } from "./DocsVariants";
...
const meta = {
  ...
  argTypes: {
    ...
    items: { control: false, description: "Uma entrada por variante. O preview é um nó React." },
  ...
  args: {
    ...
    items: [
      ...
      },
      {
        ...
        preview: <Button variant="destructive">Excluir</Button>,
      },
    ],
  },
} satisfies Meta<typeof DocsVariants>;
    ...
    items: [
      {
        ...
        preview: <Button variant="ghost">Editar</Button>,
      },
    ],
  },
  parameters: { controls: { disable: true } },
