...
export function ComposerContextDocs() {
  ...
  /** Um composer com contexto, sem repetir os rótulos em cada chamada. */
  const withContext = (items: ContextItem[]) => (
    <Composer labels={labels} contextLabels={contextLabels} context={items} />
  );
  ...
  const examples = [
    example("demonstration.labels.kinds", withContext(everyKind())),
    example("demonstration.labels.detail", withContext(selection())),
    example("demonstration.labels.automatic", withContext(automatic())),
    example("demonstration.labels.withField", withContext(mixed())),
  ];
  ...
  return (
    ...
    >
        ...
        pairs={[
          {
            ...
            // O par é a MESMA lista: o que muda é se a espécie chega em palavra
            // a quem não vê os ícones.
            doPreview: withContext(everyKind()),
            // O contraexemplo: a palavra da espécie apagada, e a distinção
            // entre trecho e arquivo inteiro passa a existir só no desenho.
            dontPreview: (
              <Composer
                labels={labels}
                contextLabels={{
          ...
          },
          {
            ...
            doPreview: withContext(mixed()),
            // O contraexemplo: a marca apagada, e o que entrou sozinho passa a
            // se distinguir só pela moldura tracejada.
            dontPreview: (
              <Composer
                labels={labels}
      ...
      <DocsImport
        ...
        secondaryCode={tContent("import.withAutomaticCode")}
      />
