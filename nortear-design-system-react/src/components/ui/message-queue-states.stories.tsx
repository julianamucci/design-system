...
/**
 * A fila, com a assinatura do idioma no ponto de uso.
 *
 ...
 */
function StateExample({ messages }: { messages: QueuedMessage[] }) {
...
export const Waiting: Story = {
  ...
  render: () => <StateExample messages={waiting()} />,
...
export const Sending: Story = {
  ...
  render: () => <StateExample messages={sending()} />,
  play: async ({ canvasElement, step }) => {
    const list = listOf(canvasElement)!
    const labels = queueLabels()
...
export const Empty: Story = {
  ...
  // Sem mensagem o componente devolve nada, e a story desenha exatamente isso:
  // não há moldura em volta para segurar a ausência.
  render: () => <StateExample messages={[]} />,
  play: async ({ canvasElement, step }) => {
