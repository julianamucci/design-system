...
import { ComputerUseDocs } from "@/components/docs/ComputerUseDocs"
...
function PlaygroundExample({ status, activeIndex, withSteps }: PlaygroundArgs) {
  return (
    <ComputerUse
      url={COMPUTER_URL}
      screen={<DemoScreen />}
      steps={withSteps ? COMPUTER_STEPS_LOGIN : []}
