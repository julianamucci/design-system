...
import { amountOf, budgetOf, useCostMeterLabels } from "./cost-meter.fixtures"
import { useContextDisplayLabels } from "./context-display.fixtures"
import { useAgentStatusLabels } from "./agent-status.fixtures"
import {
...
/** Os rótulos vêm de hook, então o render passa por um componente. */
function AfterRunExample() {
  return (
    <div className="nds-stack nds-max-w-lg" data-spacing="sm">
      <AgentStatus status="complete" labels={useAgentStatusLabels()} />
      <CostMeter
