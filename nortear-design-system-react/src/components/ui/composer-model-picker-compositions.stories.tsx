...
/**
 * O seletor dentro do campo.
 *
 * Ele é AUTÔNOMO: não é uma prop do composer. Quem consome o monta e o põe no
 * trilho, pelo mesmo espaço de qualquer outro controle.
 */
function InRailExample() {
  return (
    <Composer
...
/** O seletor sozinho, fechado, para o teclado percorrê-lo do começo. */
...
/**
 * O seletor ao lado de um alvo FORA dele.
 *
 * O alvo existe só para a play ter onde acionar, e por isso é texto inerte: um
 * botão de verdade acrescentaria um controle sem assunto à foto e ao percurso
 * do teclado.
 */
  ...
  return (
    <div className="nds-stack" data-spacing="md">
      <ComposerModelPicker
        ...
        onValueChange={onValueChange}
      />
      <p className="nds-text-caption nds-text-muted-foreground" data-slot="outside-target">
        Fora do seletor
      </p>
    </div>
  )
