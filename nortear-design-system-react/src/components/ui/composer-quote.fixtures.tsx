...
type QuoteContent = { labels: ComposerQuoteLabels }

const CONTENT = quoteTranslations as unknown as Record<string, QuoteContent>

function read(locale: Locale): ComposerQuoteLabels {
  return (CONTENT[locale] ?? CONTENT["pt-BR"]).labels
}

/** Os rótulos da citação, no idioma corrente. Para dentro de um componente. */
export function useQuoteLabels(): ComposerQuoteLabels {
