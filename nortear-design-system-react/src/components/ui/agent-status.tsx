 ...
 * as stacks, porque aqui não há estado imperativo para traduzir. O estado entra
 * como dado e sai como desenho.
 */
...
function AgentStatus({
  ...
  return (
    ...
    <p
      ...
      className={cn("nds-agent-status", className)}
      data-status={status}
    >
      ...
      <span
        className="nds-agent-status-dot"
        data-slot="agent-status-dot"
        aria-hidden="true"
      />

      <span className="nds-agent-status-label" data-slot="agent-status-label">
      ...
      {elapsed ? (
        <span
          className="nds-agent-status-elapsed"
