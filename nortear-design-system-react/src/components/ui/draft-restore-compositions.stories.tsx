 ...
 * é do desenho da faixa (`margin-block-end`), e uma pilha por cima somaria o
 * gap dela ao respiro que a folha já declarou.
 */
function AboveComposerExample({ timestamp }: { timestamp?: string }) {
  return (
    <div className="nds-max-w-lg">
      <DraftRestore
        ...
        onAction={onAction}
      />
      <Composer labels={useComposerLabels()} />
    </div>
  )
}
...
export const AboveComposer: Story = {
  ...
  render: () => <AboveComposerExample timestamp={SAMPLE_TIMESTAMP} />,
