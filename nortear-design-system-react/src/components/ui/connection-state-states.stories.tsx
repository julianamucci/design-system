 ...
 */
function StateExample({ state }: { state: ConnectionStateValue }) {
  return (
    <ConnectionState
      state={state}
...
export const Connected: Story = {
  ...
  render: () => <StateExample state="connected" />,
  play: async ({ canvasElement, step }) => {
...
export const Reconnecting: Story = {
  ...
  render: () => <StateExample state="reconnecting" />,
  play: async ({ canvasElement, step }) => {
    const line = lineOf(canvasElement)
    const labels = connectionStateLabels()
...
export const Disconnected: Story = {
  ...
  render: () => <StateExample state="disconnected" />,
  play: async ({ canvasElement, step }) => {
    const line = lineOf(canvasElement)
    const labels = connectionStateLabels()
