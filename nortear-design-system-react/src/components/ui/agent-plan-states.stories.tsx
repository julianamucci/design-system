...
function PlanExample({ steps }: { steps: PlanStep[] }) {
  return (
    <div className="nds-max-w-lg">
      <AgentPlan steps={steps} labels={useAgentPlanLabels()} />
    </div>
  )
}
...
export const EveryState: Story = {
  ...
  render: () => <PlanExample steps={everyStatePlan()} />,
...
export const Proposed: Story = {
  ...
  render: () => <PlanExample steps={proposedPlan()} />,
  play: async ({ canvasElement, step }) => {
    const steps = stepsOf(canvasElement)
...
export const InProgress: Story = {
  ...
  render: () => <PlanExample steps={runningPlan()} />,
  play: async ({ canvasElement, step }) => {
    const steps = stepsOf(canvasElement)
...
export const Finished: Story = {
  ...
  render: () => <PlanExample steps={finishedPlan()} />,
  play: async ({ canvasElement, step }) => {
    const steps = stepsOf(canvasElement)
    const labels = agentPlanLabels()
...
export const LongLabel: Story = {
  ...
  render: () => <PlanExample steps={longLabelPlan()} />,
  play: async ({ canvasElement, step }) => {
