...
/**
 * Sem total conhecido, por dois caminhos.
 *
 * Uma omite o total, a outra manda zero. Zero é o erro mais fácil de cometer,
 * porque parece um número, e é justamente o que desenharia trilha vazia —
 * "acabou de começar" — para algo que já andou muito.
 */
function UnknownTotalExample() {
  const label = useJobLabel()
  const labels = useJobProgressLabels()
  return (
    <div className="nds-stack" data-spacing="lg">
