...
function TimingCase({ name }: { name: MessageTimingCase }) {
  return (
    <MessageTiming
      stats={statsOf(name)}
...
export const Measuring: Story = {
  ...
  render: () => <TimingCase name="measuring" />,
...
export const Settled: Story = {
  ...
  render: () => <TimingCase name="settled" />,
  play: async ({ canvasElement, step }) => {
    const root = rootOf(canvasElement)
    const labels = messageTimingLabels()
...
export const PartialMeasures: Story = {
  ...
  render: () => <TimingCase name="partial" />,
  play: async ({ canvasElement, step }) => {
    const root = rootOf(canvasElement)
