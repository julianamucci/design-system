...
import { messageTimingLabels, statsOf, useMessageTimingLabels } from "./message-timing.fixtures"
import { messageTimingSource } from "./message-timing.source"
import { MessageTimingDocs } from "@/components/docs/MessageTimingDocs"
...
function PlaygroundExample({ measures, streaming }: PlaygroundArgs) {
  return (
    <MessageTiming
      ...
      stats={statsOf("settled").slice(0, measures)}
      streaming={streaming}
