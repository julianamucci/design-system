...
import { DraftRestoreDocs } from "@/components/docs/DraftRestoreDocs"
...
function PlaygroundExample({ draft, timestamp }: PlaygroundArgs) {
  return (
    <DraftRestore
      labels={useDraftLabels()}
      draft={draft}
...
const meta: Meta<PlaygroundArgs> = {
  ...
  parameters: {
    ...
    docs: {
      page: withAutoDocsTab(DraftRestoreDocs),
