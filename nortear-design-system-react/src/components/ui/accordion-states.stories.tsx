...
export const Closed: Story = {
  ...
  play: async ({ canvasElement, step }) => {
    ...
    await step("Fechado, o gatilho ainda aponta para o painel", async () => {
      ...
      // gatilho e conteúdo — e o base-ui o apagava com o item fechado, deixando
      // o par sem relação nenhuma. Ver o contexto de ids em accordion.tsx.
...
export const Open: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          "Estado aberto. aria-expanded=\"true\" no trigger. Conteúdo visível e acessível.",
      },
    },
  },
  play: async ({ canvasElement, step }) => {
...
export const FocusVisible: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          "Navegação por teclado. Tab move entre triggers. Enter e Space abrem/fecham. Focus ring ring-[3px] visível.",
      },
    },
  },
  play: async ({ canvasElement, step }) => {
