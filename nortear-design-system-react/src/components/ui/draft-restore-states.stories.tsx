...
import { DraftRestore, type DraftRestoreProps } from "./draft-restore"
import {
  SAMPLE_DRAFT,
  SAMPLE_DRAFT_LONG,
  SAMPLE_TIMESTAMP,
...
function StateExample(props: Omit<DraftRestoreProps, "labels">) {
  return <DraftRestore labels={useDraftLabels()} onAction={onAction} {...props} />
}
...
export const Found: Story = {
  ...
  render: () => <StateExample draft={SAMPLE_DRAFT} />,
...
export const Dated: Story = {
  ...
  render: () => <StateExample draft={SAMPLE_DRAFT} timestamp={SAMPLE_TIMESTAMP} />,
  play: async ({ canvasElement, step }) => {
    await step("O carimbo acompanha o título", async () => {
      const stamp = titleOf(canvasElement).querySelector<HTMLElement>(
...
export const LongDraft: Story = {
  ...
  render: () => <StateExample draft={SAMPLE_DRAFT_LONG} timestamp={SAMPLE_TIMESTAMP} />,
  play: async ({ canvasElement, step }) => {
