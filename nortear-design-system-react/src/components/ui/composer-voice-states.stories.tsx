...
import { ComposerVoice, type ComposerVoiceProps } from "./composer-voice"
import {
  SAMPLE_ELAPSED,
  SAMPLE_ELAPSED_DONE,
  SAMPLE_LEVEL,
...
function StateExample(props: Omit<ComposerVoiceProps, "labels">) {
  return <ComposerVoice labels={useVoiceLabels()} onToggle={onToggle} {...props} />
}
...
export const Idle: Story = {
  ...
  render: () => <StateExample state="idle" />,
...
export const Recording: Story = {
  ...
  render: () => (
    <StateExample state="recording" level={SAMPLE_LEVEL} elapsed={SAMPLE_ELAPSED} />
  ),
  play: async ({ canvasElement, step }) => {
    const canvas = within(canvasElement)
    const labels = voiceLabels()
...
export const Transcribing: Story = {
  ...
  render: () => <StateExample state="transcribing" elapsed={SAMPLE_ELAPSED_DONE} />,
  play: async ({ canvasElement, step }) => {
    const canvas = within(canvasElement)
    const labels = voiceLabels()
...
export const Disabled: Story = {
  ...
  render: () => <StateExample state="idle" disabled />,
  play: async ({ canvasElement, step }) => {
    const canvas = within(canvasElement)
