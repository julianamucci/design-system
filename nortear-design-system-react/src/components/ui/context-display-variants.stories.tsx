...
function FormExample({ form }: { form: ContextDisplayForm }) {
  return (
    <ContextDisplay
...
export const EveryForm: Story = {
  ...
  play: async ({ canvasElement, step }) => {
    ...
    await step("Há um bloco por forma, na ordem da lista", async () => {
      ...
      await expect(blocks.map((block) => block.dataset.form)).toEqual([...CONTEXT_DISPLAY_FORMS])
    })
