...
function StateExample({ calls, open = false }: { calls: ChatToolCall[]; open?: boolean }) {
  return <ToolGroup calls={calls} labels={useToolGroupLabels()} open={open} />
}
...
export const EveryState: Story = {
  ...
  render: () => (
    <StateExample
      calls={TOOL_CALL_STATES.map((state) => ({
        id: state,
...
export const Failed: Story = {
  ...
  render: () => <StateExample calls={TOOL_CALLS_WITH_FAILURE} />,
  play: async ({ canvasElement, step }) => {
    const group = groupOf(canvasElement)
    const labels = toolGroupLabels()
...
export const Done: Story = {
  ...
  render: () => <StateExample calls={TOOL_CALLS_ALL_DONE} />,
  play: async ({ canvasElement, step }) => {
    const group = groupOf(canvasElement)
    const labels = toolGroupLabels()
...
export const Running: Story = {
  ...
  render: () => <StateExample calls={TOOL_CALLS_RUNNING} />,
  play: async ({ canvasElement, step }) => {
    const group = groupOf(canvasElement)
    const labels = toolGroupLabels()
