 ...
 *
 * DOIS acessos ao mesmo dicionário, como em `job-progress.fixtures.tsx`, e a
...
const CONTENT = terminalTranslations as unknown as Record<string, TerminalContent>
 ...
 * andaime.
 */
function read(locale: Locale): TerminalBlockLabels {
  ...
  return { status, exitCode: raw.exitCode }
}

/** Os rótulos da peça, no idioma corrente. Para dentro de um componente. */
export function useTerminalBlockLabels(): TerminalBlockLabels {
