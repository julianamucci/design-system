...
import { ApprovalCardDocs } from "@/components/docs/ApprovalCardDocs"
...
function PlaygroundExample({ question, scope }: PlaygroundArgs) {
  ...
  return (
    <ApprovalCard
      ...
      scope={scope === "none" ? undefined : approvalScope(labels, scope)}
...
const meta: Meta<PlaygroundArgs> = {
  ...
  args: {
    question: approvalQuestion(approvalCardLabels(), "publish"),
    scope: "publish",
  },
}
...
export const Playground: Story = {
  ...
  play: async ({ canvasElement, step, args }) => {
    ...
    await step("E cada termo do alcance chega pareado com o seu valor", async () => {
      ...
      const expected = approvalScope(labels, args.scope)
