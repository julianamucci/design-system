...
import { attachmentLabels, one, useAttachmentLabels } from "./composer-attachments.fixtures"
import {
...
function StateExample({ attachments }: { attachments: Attachment[] }) {
  return (
    <Composer
...
export const Pending: Story = {
  ...
  render: () => <StateExample attachments={one("pending")} />,
...
export const Uploading: Story = {
  ...
  render: () => <StateExample attachments={one("uploading", { progress: 0.4 })} />,
  play: async ({ canvasElement, step }) => {
...
export const Ready: Story = {
  ...
  render: () => <StateExample attachments={one("ready")} />,
  play: async ({ canvasElement, step }) => {
    const item = itemOf(canvasElement)
...
export const Failed: Story = {
  ...
  render: () => <StateExample attachments={one("failed")} />,
  play: async ({ canvasElement, step }) => {
    const item = itemOf(canvasElement)
