...
import { CostMeter, type CostBudget } from "./cost-meter"
import { costAmount, costMeterLabels, useCostMeterLabels } from "./cost-meter.fixtures"
...
import { CostMeterDocs } from "@/components/docs/CostMeterDocs"
...
function budgetFrom(args: PlaygroundArgs): CostBudget | undefined {
