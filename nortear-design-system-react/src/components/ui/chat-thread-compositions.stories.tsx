...
function ThreadComAcoes() {
  ...
  return <ChatThread messages={messages} labels={labels} size="lg" />
}

export const WithActions: Story = {
  parameters: { covers: ["accessibility.item4"] },
  render: () => <ThreadComAcoes />,
  play: async ({ canvasElement, step }) => {
