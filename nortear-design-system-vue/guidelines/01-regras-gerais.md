...
* **É OBRIGATÓRIO que o anel use `--ring` com 100% da cor (SEM opacidade como /50 ou /30)** — a `.nds-focus-ring` já entrega assim
...
* **NÃO recrie tamanho de fonte nem altura de linha com utilitária avulsa** — a escala tipográfica está na folha `typography.css`, nas classes `.nds-text-*`, e responde ao tema, à densidade e à escolha de fonte
