...
export const Playground: Story = {
  ...
  render: (args) => ({
    ...
    setup() {
      ...
      return {
        ...
        steps: computed(() => (args.withSteps ? COMPUTER_STEPS_LOGIN : [])),
      };
    },
    // A TELA ENTRA PELO SLOT NOMEADO: ela é espaço de quem consome, e nesta
    // stack espaço se escreve no template.
  ...
  play: async ({ canvasElement, step, args }) => {
    ...
    await step('O endereço aparece, com a palavra que só quem ouve recebe', async () => {
      ...
      // da peça — e por isso some em silêncio quando alguém copia a árvore pela
