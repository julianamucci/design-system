...
export const InRail: Story = {
  ...
  render: () => ({
    components: { Composer, ComposerModelPicker },
    setup() {
      return {
        labels: useComposerLabels(),
        pickerLabels: useModelLabels(),
        models: everyModel(),
        onChange,
      };
    },
...
export const Keyboard: Story = {
  ...
  render: () => ({
    ...
    setup() {
      return { labels: useModelLabels(), models: availableModels(), onChange };
    },
...
export const OutsideClick: Story = {
  ...
  render: () => ({
    ...
    // inerte: um botão de verdade acrescentaria um controle sem assunto à foto
    // e ao percurso do teclado.
