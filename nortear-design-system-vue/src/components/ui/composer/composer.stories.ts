...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      ...
      // Sem a transform o gerador imprime a tag sozinha, sem os rótulos e sem o
      // vínculo de texto que o componente exige. O painel mostra o uso real.
  ...
  argTypes: {
    ...
    running: {
      control: 'boolean',
      description:
        'Se a resposta está sendo gerada. É quem consome que sabe: o componente não acompanha a rede.',
...
export const Playground: Story = {
  ...
  render: (args) => ({
    ...
    setup() {
      ...
      return { args, labels: useComposerLabels(), onSubmit };
    },
    template:
      '<Composer v-bind="args" :labels="labels" class="nds-max-w-lg" @submit="onSubmit" />',
  }),
