...
import { TraceWaterfall, type TraceWaterfallLabels } from './index';
 ...
 */
function everyStateSpans(labels: TraceWaterfallLabels): TraceSpan[] {
...
export const EveryState: Story = {
  ...
  render: () => ({
    ...
    setup() {
      ...
      return {
        labels,
        spans: computed(() => everyStateSpans(labels.value)),
      };
    },
