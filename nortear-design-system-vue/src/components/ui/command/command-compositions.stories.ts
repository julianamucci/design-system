...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      ...
      description: {
        component:
          'Os arranjos da paleta: atalhos por comando e a paleta dentro de um Dialog '
          + '(command palette). Nenhuma peça nova entra aqui: é composição de call site. '
          + 'A lista dividida em grupos é VARIANTE (variants.items.withGroups) e mora em Variants.',
      },
    },
  },
