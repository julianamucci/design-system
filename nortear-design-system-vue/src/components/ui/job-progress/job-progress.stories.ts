...
import { jobLabel, useJobLabel, useJobProgressLabels, jobProgressLabels } from './job-progress.fixtures';
...
export const Playground: Story = {
  ...
  play: async ({ canvasElement, step, args }) => {
    ...
    await step('A barra mostra o que o vocabulário decide', async () => {
      ...
      // O nome é o rótulo do trabalho: sem ele, o leitor diz quanto, nunca de quê.
