  ...
  return vueSnippet(
    ...
    tabs({
      raiz: attrs(
        ...
        `class="nds-w-full nds-max-w-${vertical ? 'lg' : 'md'}"`,
      ).trim(),
...
export function tabsPadraoSource(): string {
  return vueSnippet(
    IMPORT,
    tabs({
      raiz: 'default-value="overview" class="nds-w-full nds-max-w-md"',
      rotuloLista: 'Seções do componente',
      abas: SECOES,
    }),
  );
...
export function tabsVerticalSource(): string {
  return vueSnippet(
    IMPORT,
    tabs({
      raiz: 'default-value="profile" orientation="vertical" class="nds-w-full nds-max-w-lg"',
...
export function tabsAbaAtivaSource(): string {
  return vueSnippet(
    IMPORT,
    tabs({
      raiz: 'default-value="properties" class="nds-w-full nds-max-w-md"',
      rotuloLista: 'Seções do componente',
      abas: SECOES,
    }),
  );
...
import { Code2, Eye, Settings2 } from 'lucide-vue-next'`,
    tabs({
      raiz: 'default-value="preview" class="nds-w-full nds-max-w-md"',
      lista: 'variant="line"',
...
import { Badge } from '@/components/ui/badge'`,
    tabs({
      raiz: 'default-value="inbox" class="nds-w-full nds-max-w-md"',
...
export function tabsModoManualSource(): string {
  return vueSnippet(
    IMPORT,
    tabs({
      raiz: 'default-value="overview" activation-mode="manual" class="nds-w-full nds-max-w-md"',
      rotuloLista: 'Seções do componente',
      abas: [
        {
          valor: 'overview',
