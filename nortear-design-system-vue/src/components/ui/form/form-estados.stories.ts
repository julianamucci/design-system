...
export const Invalid: Story = {
  ...
  render: () => ({
    ...
    template: `
      ...
      >
        <Input type="password" model-value="123" aria-invalid="true" autocomplete="new-password" />
      </FormField>
    `,
  }),
...
export const Disabled: Story = {
  ...
  render: () => ({
    ...
    template: `
      ...
      >
        <Input type="text" model-value="000.000.000-00" disabled />
      </FormField>
    `,
  }),
  play: async ({ canvasElement, step }) => {
...
export const DarkPalette: Story = {
  ...
  render: () => ({
    components: { FormField, Fieldset, Input },
    template: `
      <div class="nds-stack nds-max-w-sm">
        ...
        >
          <Input type="email" model-value="joao@" aria-invalid="true" />
        </FormField>
        <Fieldset legend="Endereço de entrega">
          <FormField label="Cidade">
            <Input type="text" model-value="São Paulo" disabled />
          </FormField>
        </Fieldset>
      </div>
    `,
