...
import { activityGraphLabels, useActivityGraphLabels } from './activity-graph.fixtures';
...
export const Playground: Story = {
  ...
  // O INVÓLUCRO existe para a asserção ter a que apontar quando não há grade:
  // sem janela a peça não desenha nada, nem moldura, nem camada que rola.
  render: (args) => ({
    ...
    setup() {
      return {
        ...
        days: computed(() => (args.withActivity ? ACTIVITY_DAYS : [])),
        start: ACTIVITY_START,
        end: ACTIVITY_END,
        thresholds: ACTIVITY_THRESHOLDS,
      };
    },
    template: `<div data-testid="activity-graph-host">
      <ActivityGraph
        :days="days"
        :start="start"
        :end="end"
