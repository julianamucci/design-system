  ...
  render: () => ({
    ...
    template: `
      <div class="nds-stack nds-w-xs" data-spacing="xs">
        <label for="estado-padrao" class="nds-text-body nds-font-medium">Nome completo</label>
...
export const Focus: Story = {
  ...
  render: () => ({
    ...
    template: `
      <div class="nds-stack nds-w-xs" data-spacing="xs">
        <label for="estado-foco" class="nds-text-body nds-font-medium">Nome completo</label>
...
export const WithPlaceholder: Story = {
  render: () => ({
    ...
    template: `
      <div class="nds-stack nds-w-xs" data-spacing="xs">
        <label for="estado-placeholder" class="nds-text-body nds-font-medium">Email</label>
...
export const Disabled: Story = {
  ...
  render: () => ({
    ...
    template: `
      <div class="nds-stack nds-w-xs" data-spacing="xs">
        <label for="estado-disabled" class="nds-text-body nds-font-medium">Campo desabilitado</label>
...
export const Error: Story = {
  ...
  render: () => ({
    ...
    template: `
      <div class="nds-stack nds-w-xs" data-spacing="xs">
        <label for="estado-erro" class="nds-text-body nds-font-medium">Email</label>
        <Input
          id="estado-erro"
          type="email"
        ...
        />
        <p id="estado-erro-msg" class="nds-text-body nds-text-destructive">
...
export const DarkPalette: Story = {
  ...
  render: () => ({
    components: { Input },
    template: `
      <div class="nds-stack nds-w-xs" data-spacing="md">
        <div class="nds-stack" data-spacing="xs">
          <label for="dk-padrao" class="nds-text-body nds-font-medium">Padrão</label>
          <Input id="dk-padrao" type="text" placeholder="ex: João da Silva" />
        </div>
        <div class="nds-stack" data-spacing="xs">
          <label for="dk-erro" class="nds-text-body nds-font-medium">Com erro</label>
          <Input id="dk-erro" type="email" aria-invalid="true" aria-describedby="dk-erro-msg" />
          <p id="dk-erro-msg" class="nds-text-body nds-text-destructive">Email inválido</p>
        </div>
        <div class="nds-stack" data-spacing="xs">
          <label for="dk-off" class="nds-text-body nds-font-medium">Desabilitado</label>
