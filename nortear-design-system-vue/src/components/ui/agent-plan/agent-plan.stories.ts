...
import { SAMPLE_DETAIL, SAMPLE_STEP, agentPlanLabels, useAgentPlanLabels } from './agent-plan.fixtures';
...
export const Playground: Story = {
  ...
  render: (args) => ({
    ...
    template: `<AgentPlan :steps="steps" :labels="labels" />`,
  }),
