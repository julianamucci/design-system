...
const codeWithCounter = `<div class="nds-stack" data-spacing="sm">
  <Label :for="'description'">Descrição</Label>
  <Textarea
    id="description"
    v-model="value"
...
const relatedItems = computed(() => [
  { name: 'Input',    description: toPlainText(tContent('related.items.input.description')),    path: '?path=/docs/components-form-input--docs'    },
  { name: 'Label',    description: toPlainText(tContent('related.items.label.description')),    path: '?path=/docs/components-form-label--docs'    },
  { name: 'Form',     description: toPlainText(tContent('related.items.form.description')),     path: '?path=/docs/components-form-form--docs'     },
  { name: 'InputOTP', description: toPlainText(tContent('related.items.inputOTP.description')), path: '?path=/docs/components-form-inputotp--docs' },
]);
