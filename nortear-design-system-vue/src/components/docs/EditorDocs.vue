...
const relatedItems = computed(() => [
  ...
  { name: 'CodeBlock',   description: toPlainText(tContent('related.codeBlock')),   path: '?path=/docs/components-display-codeblock--docs'   },
  { name: 'ToggleGroup', description: toPlainText(tContent('related.toggleGroup')), path: '?path=/docs/components-form-togglegroup--docs' },
