...
const tokenRows = computed(() => [
  // A coluna do meio nomeia o SELETOR que lê o token na folha `nds/card.css`,
  // não a classe utilitária da era anterior.
  { token: '--radius-card',     value: '.nds-card',               description: tContent('tokens.table.radiusCard')      },
  { token: '--card',            value: '.nds-card',               description: tContent('tokens.table.card')            },
  { token: '--card-foreground', value: '.nds-card',               description: tContent('tokens.table.cardForeground')  },
  { token: '--muted',           value: '.nds-card-footer',        description: toPlainText(tContent('tokens.table.muted'))       },
  { token: '--muted-foreground', value: '.nds-card-description',  description: tContent('tokens.table.mutedForeground') },
  { token: '--foreground',      value: '.nds-card',               description: toPlainText(tContent('tokens.table.foreground'))  },
  { token: '--border',          value: '.nds-card-footer',        description: tContent('tokens.table.border')          },
