...
const relatedItems = computed(() => [
  { name: tContent('related.items.drawer.name'),      description: toPlainText(tContent('related.items.drawer.description')),      path: '?path=/docs/primitives-overlay-drawer--docs'      },
