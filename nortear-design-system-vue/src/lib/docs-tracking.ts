 ...
 * Exportado para que o `DocsNav` use exatamente a mesma derivação quando a
 * docs page não passa `componentSlug` — sem ela o `data-track-id` do nav some.
 */
