...
<DocsPageLayout navGroups={NAV_GROUPS} {activeSection} componentSlug="pagination">
  {#snippet header()}
    <DocsHeader
      title={$tStore('title')}
  ...
  <DocsTokens
    ...
    items={[
      ...
      { token: '--accent',     value: $tStore('tokens.table.accentForeground.class'),  description: $tStore('tokens.table.accentForeground.part')  },
