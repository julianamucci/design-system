...
<div class="nds-stack" data-spacing="sm" style="width: 320px">
  ...
  <Collapsible bind:open>
    <CollapsibleTrigger
      class="nds-cluster nds-rounded-md nds-py-2 nds-text-body nds-font-medium nds-transition-colors nds-hover-bg-accent nds-hover-text-accent-foreground nds-focus-ring" data-align="center" data-spacing="sm" style="padding-inline: 0.75rem"
    >
