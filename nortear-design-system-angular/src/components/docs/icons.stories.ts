 ...
 * nenhuma. Esta stack era a única sem NENHUM arquivo de story para icons — as
 * outras quatro tinham um stub `!test` herdado da migração para MDX, que não
 * verificava nada. A saída não foi clonar o quinto stub: foi trocar os quatro
 * por esta suíte, que finalmente cobre busca, estado vazio e cópia.
 *
...
const meta: Meta = {
  ...
  tags: ['!dev'],
  decorators: [moduleMetadata({ imports: [NdsIconsDocs] })],
  parameters: {
    layout: 'fullscreen',
