...
import { NdsComposerModelPickerDocs } from '@/components/docs/ComposerModelPickerDocs';
...
const meta: Meta<PlaygroundArgs> = {
  ...
  parameters: {
    ...
    docs: {
      page: withAutoDocsTab(NdsComposerModelPickerDocs),
      ...
      // real: um componente que guarda a lista e trata o modelo confirmado.
