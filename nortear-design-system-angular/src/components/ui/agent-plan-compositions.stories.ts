 ...
 *
 * As duas peças são IRMÃS: nenhuma é entrada da outra, e nenhum arquivo de uma
 * sabe que a outra existe. Quem consome as monta lado a lado, nesta ordem — a
 * linha diz em que pé está a resposta, e o plano detalha os passos dentro dela.
 */
 ...
 * estado da linha acima. É a decisão de não criar um segundo componente, escrita
 * em código.
 */
