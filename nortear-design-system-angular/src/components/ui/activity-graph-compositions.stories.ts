...
import { NdsActivityGraph } from './activity-graph';
...
export const TightCells: Story = {
  ...
  // preciso haver duas.
  //
  // A propriedade é declarada NO PRÓPRIO elemento, e não no invólucro: a
  // folha a declara em `.nds-activity-graph`, e propriedade personalizada
  // declarada dentro do próprio seletor vence a herança — o invólucro nunca
  // a alcançaria.
  render: () => ({
    props: {
      days: ACTIVITY_DAYS,
    ...
    template: `
      <div class="nds-stack nds-w-full" data-spacing="lg">
        ...
        <div data-testid="activity-graph-tight-cells">
          <div
            ndsActivityGraph
            [days]="days"
            start="${ACTIVITY_MONTH_START}"
            ...
            status="complete"
            [labels]="labels"
            [style.--activity-graph-cell]="tightCell"
          ></div>
        </div>
      </div>
    `,
