 ...
 *
 * É o único caso em que esta peça não desenha nada dentro do host — e não é
 * o caso da atividade vazia, que continua sendo uma grade. Nesta stack o
 * host continua no documento, porque quem o escreve é quem consome; o que a
 * peça controla é tudo o que estaria dentro dele. Devolver moldura vazia
...
export const NoWindow: Story = {
  ...
  render: () => ({
    props: {
      days: ACTIVITY_DAYS,
      thresholds: ACTIVITY_THRESHOLDS,
      noScaleThresholds: [] as readonly number[],
