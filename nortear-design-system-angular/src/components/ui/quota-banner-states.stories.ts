...
export const AllLevels: Story = {
  ...
  render: () => ({
    props: {
      quotas: (['normal', 'warning', 'critical'] as const).map((name) => quotaOf(name)),
      horizon: renewalOf('normal'),
      labels: quotaBannerLabels(),
    },
    template: `
 ...
 *
 * Crédito comprado uma vez é situação real, e a linha some em vez de dizer
