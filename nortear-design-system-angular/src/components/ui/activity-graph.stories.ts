...
import { mountActivityGraph, activityGraphLabels } from './activity-graph.fixtures';
import { activityGraphSource } from './activity-graph.source';
import { NdsActivityGraphDocs } from '@/components/docs/ActivityGraphDocs';
...
const meta: Meta<PlaygroundArgs> = {
  ...
  parameters: {
    ...
    docs: {
      page: withAutoDocsTab(NdsActivityGraphDocs),
      // O renderer desta stack imprime o `template` da story com os bindings
      // apontando para membros que só existem aqui. A transform devolve o
      // uso real: um componente que declara os dias, a janela, a escala e os
      // rótulos.
