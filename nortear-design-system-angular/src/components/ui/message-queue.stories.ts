...
import { NdsMessageQueueDocs } from '@/components/docs/MessageQueueDocs';
...
const meta: Meta<PlaygroundArgs> = {
  ...
  parameters: {
    ...
    docs: {
      page: withAutoDocsTab(NdsMessageQueueDocs),
      ...
      // real: um componente que guarda as mensagens que esperam e trata o
      // pedido de retirada — e, no Playground, com a mensagem por extenso.
...
export const Playground: Story = {
  ...
  render: (args) => ({
    props: {
      labels: queueLabels(),
      messages: [{ id: 'm1', text: args.text, state: args.state }],
      onWithdraw,
    },
    template: `
      <nds-message-queue
