...
//
// O estado decide a palavra e o marcador; o rótulo é o que se faz; o detalhe é o
// que o rótulo não diz. A grade dos cinco estados mora em `States`; aqui o
...
const meta: Meta<PlaygroundArgs> = {
  ...
  parameters: {
    ...
    docs: {
      page: withAutoDocsTab(NdsAgentPlanDocs),
      ...
      // real: um componente que declara os passos, os rótulos e a guarda.
...
export const Playground: Story = {
  ...
  render: (args) => ({
    ...
    // A raiz é a própria lista, então a guarda fica aqui: sem passo nenhum, a
    // peça não tem como se apagar sozinha.
    template: `
      @if (steps.length) {
