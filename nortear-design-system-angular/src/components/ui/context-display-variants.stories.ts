...
export const Bar: Story = {
  ...
  play: async ({ canvasElement, step }) => {
    ...
    await step('A barra toma a linha inteira, abaixo do número', async () => {
      ...
      // O preenchimento não carrega o número: ele HERDA a propriedade
      // personalizada do trilho, que é o elemento onde ela mora nas duas formas.
