...
import { contextBreakdownLabels } from './context-breakdown.fixtures';
import { contextBreakdownSource } from './context-breakdown.source';
import { NdsContextBreakdownDocs } from '@/components/docs/ContextBreakdownDocs';
...
const meta: Meta<PlaygroundArgs> = {
  ...
  parameters: {
    ...
    docs: {
      page: withAutoDocsTab(NdsContextBreakdownDocs),
      ...
      // real: um componente que declara os rótulos e passa a repartição.
