...
import { createDocsTokens, type DocsTokensProps } from './DocsTokens';
...
const meta: Meta<DocsTokensProps> = {
  ...
  render: (args) => createDocsTokens(args),
};

export default meta;
type Story = StoryObj<DocsTokensProps>;
