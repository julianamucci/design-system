...
import { createDocsTestes, type DocsTestesProps } from './DocsTestes';
...
const meta: Meta<DocsTestesProps> = {
  ...
  render: (args) => createDocsTestes(args),
};

export default meta;
type Story = StoryObj<DocsTestesProps>;
