...
import { createDocsNotes, type DocsNotesProps } from './DocsNotes';
...
const meta: Meta<DocsNotesProps> = {
  ...
  render: (args) => createDocsNotes(args),
};

export default meta;
type Story = StoryObj<DocsNotesProps>;
