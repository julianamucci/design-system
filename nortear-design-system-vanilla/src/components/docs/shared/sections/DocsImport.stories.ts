...
import { createDocsImport, type DocsImportProps } from './DocsImport';
...
const meta: Meta<DocsImportProps> = {
  ...
  render: (args) => createDocsImport(args),
};

export default meta;
type Story = StoryObj<DocsImportProps>;
