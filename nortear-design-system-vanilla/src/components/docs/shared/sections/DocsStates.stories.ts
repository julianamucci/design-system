...
import { createDocsStates, type DocsStatesProps } from './DocsStates';
...
const meta: Meta<DocsStatesProps> = {
  ...
  render: (args) => createDocsStates(args),
};

export default meta;
type Story = StoryObj<DocsStatesProps>;
