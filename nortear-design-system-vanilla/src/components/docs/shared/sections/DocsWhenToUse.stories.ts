...
import { createDocsWhenToUse, type DocsWhenToUseProps } from './DocsWhenToUse';
...
const meta: Meta<DocsWhenToUseProps> = {
  ...
  render: (args) => createDocsWhenToUse(args),
};

export default meta;
type Story = StoryObj<DocsWhenToUseProps>;
