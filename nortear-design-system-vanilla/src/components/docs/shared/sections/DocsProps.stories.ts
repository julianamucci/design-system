...
import { createDocsProps, type DocsPropsProps } from './DocsProps';
...
const meta: Meta<DocsPropsProps> = {
  ...
  render: (args) => createDocsProps(args),
};

export default meta;
type Story = StoryObj<DocsPropsProps>;
