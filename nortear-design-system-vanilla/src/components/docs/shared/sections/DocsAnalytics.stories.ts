...
import { createDocsAnalytics, type DocsAnalyticsProps } from './DocsAnalytics';
...
const meta: Meta<DocsAnalyticsProps> = {
  ...
  render: (args) => createDocsAnalytics(args),
};

export default meta;
type Story = StoryObj<DocsAnalyticsProps>;
