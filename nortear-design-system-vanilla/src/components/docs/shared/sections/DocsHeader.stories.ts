...
import { createDocsHeader, DOCS_PAGE_TITLE_ID } from './DocsHeader';
...
const meta: Meta<DocsHeaderArgs> = {
  ...
  render: (args) =>
    createDocsHeader({
      ...
      type: args.type,
      // string vazia no controle significa AUSENTE, não nota vazia: o container
      // só desenha a linha quando a prop existe.
      installNote: args.installNote || undefined,
    }),
};

export default meta;
type Story = StoryObj<DocsHeaderArgs>;
