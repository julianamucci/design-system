...
import { createDocsRelated, type DocsRelatedProps } from './DocsRelated';
...
const meta: Meta<DocsRelatedProps> = {
  ...
  render: (args) => createDocsRelated(args),
};

export default meta;
type Story = StoryObj<DocsRelatedProps>;
