  ...
  topbar.style.height = '2.5rem';
      ...
      case 'tokens': {
        ...
        return createDocsTokens({
          ...
          items: [
            { token: '--sidebar',                  value: '.nds-sidebar-inner',                    description: t('tokens.sidebarBg') },
            { token: '--sidebar-foreground',        value: '.nds-sidebar-root',                     description: t('tokens.sidebarFg') },
            { token: '--sidebar-border',            value: '.nds-sidebar-panel',                    description: t('tokens.sidebarBorder') },
            { token: '--sidebar-accent',            value: '.nds-sidebar-menu-button:hover',        description: t('tokens.sidebarAccent') },
            { token: '--sidebar-accent-foreground', value: '.nds-sidebar-menu-button:hover',        description: t('tokens.sidebarAccentFg') },
            { token: '--sidebar-ring',              value: '.nds-sidebar-menu-button:focus-visible', description: t('tokens.sidebarRing') },
