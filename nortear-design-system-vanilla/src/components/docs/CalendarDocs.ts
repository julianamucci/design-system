...
export function createCalendar(options?: CalendarOptions): HTMLElement;`;
      ...
      case 'tokens': {
        return createDocsTokens({
          ...
          items: [
            { token: '--primary', value: '.nds-calendar-day-btn[data-selected]', description: t('tokens.table.primary') },
            { token: '--accent', value: '.nds-calendar-day-btn[data-today] · .nds-calendar-range-middle', description: t('tokens.table.muted') },
            { token: '--muted-foreground', value: '.nds-calendar-weekday · .nds-calendar-day-btn[data-outside-month]', description: t('tokens.table.mutedForeground') },
            { token: '--foreground', value: '.nds-calendar-nav-btn', description: t('tokens.table.foreground') },
            { token: '--ring', value: '.nds-calendar-day-btn:focus-visible', description: t('tokens.table.ring') },
            { token: '--nds-cell-size', value: '.nds-calendar-root', description: toPlainText(t('tokens.table.cellSize')) },
            { token: '--nds-cell-radius', value: '.nds-calendar-root', description: toPlainText(t('tokens.table.cellRadius')) },
            { token: '--nds-picker-item', value: '.nds-calendar-select', description: toPlainText(t('tokens.table.pickerItem')) },
          ],
