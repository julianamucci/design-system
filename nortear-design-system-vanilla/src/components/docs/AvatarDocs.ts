  ...
  className?: string;
      ...
      case 'tokens': {
        return createDocsTokens({
          ...
          items: [
            { token: '--muted',            value: '.nds-avatar-fallback',     description: toPlainText(t('tokens.table.muted')) },
            { token: '--muted-foreground', value: '.nds-avatar-fallback',     description: toPlainText(t('tokens.table.mutedForeground')) },
            { token: '--background',       value: '.nds-avatar-group > .nds-avatar', description: toPlainText(t('tokens.table.background')) },
            { token: '--border',           value: '—',                        description: toPlainText(t('tokens.table.border')) },
            { token: '--primary',          value: '.nds-avatar-badge',        description: toPlainText(t('tokens.table.primary')) },
            { token: '--avatar-size',      value: '.nds-avatar',              description: toPlainText(t('tokens.table.avatarSize')) },
            { token: '--radius-full',      value: '.nds-avatar',              description: toPlainText(t('tokens.table.radius')) },
            { token: '--ring',             value: '—',                        description: toPlainText(t('tokens.table.ring')) },
          ],
