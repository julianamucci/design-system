...
import { createComposerVoice } from '@/components/ui/composer-voice';
...
const { t, subscribe } = createTranslation(voiceTranslations as Record<string, unknown>);
...
function screenReaderItems(): string[] {
  ...
  const raw = (voiceTranslations as unknown as Record<
    string,
...
// ─── createComposerVoiceDocs ──────────────────────────────────────────────────

export function createComposerVoiceDocs(): HTMLElement {
        ...
        return createDocsDemonstration({
          ...
          demoFactory: () => {
            ...
            const examples = [
              ...
              example('demonstration.labels.transcribing', () =>
                voice('transcribing', SAMPLE_ELAPSED_DONE)),
          ...
          pairs: [
            {
              ...
              // O par é o MESMO controle captando: o que muda é se o estado
              // chega em palavra a quem não vê o medidor.
              doPreviewFactory: () => voice('recording', SAMPLE_ELAPSED),
              dontPreviewFactory: () =>
                createComposerVoice({
                  labels: {
                    ...voiceLabels(),
                    // O contraexemplo: a palavra do estado apagada, e a
                    // diferença entre captando e parado passa a existir só no
                    // desenho do medidor.
            ...
            },
            {
              ...
              doPreviewFactory: () => voice('transcribing', SAMPLE_ELAPSED_DONE),
              // O contraexemplo: o alternador apagado e nenhum motivo escrito
              // ao lado — a pergunta "por que não posso?" sem resposta na tela.
              dontPreviewFactory: () =>
                createComposerVoice({
                  labels: { ...voiceLabels(), status: { idle: '', recording: '', transcribing: '' } },
                  state: 'transcribing',
