...
import { createThinkingIndicatorDocs } from '@/components/docs/ThinkingIndicatorDocs';
...
const meta: Meta<PlaygroundArgs> = {
  ...
  parameters: {
    ...
    docs: {
      page: withAutoDocsTab(createThinkingIndicatorDocs),
...
export const Playground: Story = {
  ...
  render: (args) => createThinkingIndicator({ label: args.label }),
