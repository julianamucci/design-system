...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      ...
      description: {
        component: 'Cada story fixa um estado e verifica o que ele muda no panel.',
      },
    },
  },
};
...
export const Closed: Story = {
  ...
  play: async ({ canvasElement, step }) => {
    ...
    await step('Voltar o CURSOR para dentro do gatilho reabre a lista', async () => {
      // O passo que faltava, e a falta apareceu ao plantar o defeito: trocar
      // `selectionStart` pelo fim do texto não reprovava nada, porque toda
