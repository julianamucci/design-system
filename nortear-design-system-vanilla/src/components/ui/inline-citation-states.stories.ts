...
import {
  inlineCitationSourceEveryCase,
  inlineCitationSourceExpanded,
  inlineCitationSourceMinimal,
  inlineCitationSourceRefused,
...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      source: { transform: inlineCitationSourceEveryCase },
      description: {
        component:
...
const sentenceOf = (name: InlineCitationCase): HTMLElement => {
...
export const Expanded: Story = {
  parameters: {
    ...
    docs: { source: { transform: inlineCitationSourceExpanded } },
  },
...
export const Minimal: Story = {
  parameters: {
    ...
    docs: { source: { transform: inlineCitationSourceMinimal } },
  },
...
export const Refused: Story = {
  parameters: {
    ...
    docs: { source: { transform: inlineCitationSourceRefused } },
  },
