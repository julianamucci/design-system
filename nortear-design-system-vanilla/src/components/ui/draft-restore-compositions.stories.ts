...
const aboveComposer = (timestamp?: string) => {
  ...
  // Nenhum utilitário de pilha aqui, e é de propósito: a distância até o campo
  // já é do desenho da faixa (`margin-block-end`), e uma pilha por cima somaria
  // o gap dela ao respiro que a folha já declarou.
  stack.className = 'nds-max-w-lg';
