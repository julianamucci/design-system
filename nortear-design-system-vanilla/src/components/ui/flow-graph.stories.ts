...
import { createFlowGraphDocs } from '@/components/docs/FlowGraphDocs';
...
const meta: Meta<PlaygroundArgs> = {
  ...
  parameters: {
    ...
    docs: {
      page: withAutoDocsTab(createFlowGraphDocs),
...
/** O invólucro mora nas fixtures: sem nó a fábrica devolve nada, e é ele que
...
export const Playground: Story = {
  ...
  play: async ({ canvasElement, step, args }) => {
    ...
    if (args.revealed === 0) {
      // Sem nó não há grafo, e a fábrica devolve nada — nem moldura, nem camada
