...
import {
  quotaBannerSourceBesideContext,
  quotaBannerSourceWithAction,
...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      source: { transform: quotaBannerSourceWithAction },
      description: {
        component:
...
export const WithAction: Story = {
  ...
  render: () => {
    const banner = createQuotaBanner({
      quota: quotaOf('warning'),
      renewsIn: renewalOf('warning'),
      actions: [quotaBannerAction()],
      labels: quotaBannerLabels(),
    });
    banner.classList.add('nds-max-w-lg');
    return banner;
  },
...
export const BesideContext: Story = {
  parameters: {
    ...
    docs: { source: { transform: quotaBannerSourceBesideContext } },
  },
  render: () => {
