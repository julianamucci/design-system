    ...
    docs: {
      source: {
        transform: resizableSourceWith({
          ...
          panels: [
            { title: 'Editor', defaultSize: 50, minSize: 25 },
            { title: 'Preview', defaultSize: 50, minSize: 25 },
          ],
        }),
      },
    },
      ...
      source: {
        transform: resizableSourceNested({
          interno: {
            ...
            panels: [
              { title: 'Conteúdo', defaultSize: 70, minSize: 30 },
              { title: 'Console', defaultSize: 30, minSize: 15 },
            ],
          },
          externo: {
            withHandle: true,
            ...
            panels: [
              { title: 'Arquivos', defaultSize: 25, minSize: 15 },
              { title: 'Área principal', defaultSize: 75, minSize: 40 },
            ],
          },
          neighbour: { title: 'Arquivos', defaultSize: 25, minSize: 15 },
        }),
      },
    },
  },
    ...
    docs: {
      source: {
        transform: resizableSourceWith({
          ...
          panels: [
            { title: 'Inbox (4)', defaultSize: 35, minSize: 20 },
            { title: 'Detalhe', defaultSize: 65, minSize: 35 },
          ],
        }),
      },
    },
