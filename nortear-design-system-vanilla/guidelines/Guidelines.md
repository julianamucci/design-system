# Documentação do Design System — Guidelines (Nortear)
...
### 1. Fundamentos (Nortear — Vanilla TS)

- **[01-regras-gerais.md](./01-regras-gerais.md)** — Regras gerais obrigatórias do projeto Nortear (funções TypeScript, DOM, lucide vanilla)
...
### 2. Componentes por Categoria (Nortear / Vanilla TS)
...
### 4. Arquitetura e Design Sistema (Nortear)
...
2. Consulte as **guidelines Nortear** deste diretório para regras específicas de Vanilla TS e DOM
...
1. **Regras Gerais** (01) — Aplicam-se a todo o projeto Nortear
...
- Se a regra é específica do Nortear/Vanilla TS → adicionar neste diretório
