...
export function AccordionDocs() {
  ...
  const codeSingle = `<Accordion type="single" collapsible className="w-full max-w-lg">
  ...
  const codeMultiple = `<Accordion type="multiple" className="w-full max-w-lg">
  <AccordionItem value="item-1">
    <AccordionTrigger>Primeiro painel</AccordionTrigger>
    <AccordionContent>Conteúdo do primeiro painel.</AccordionContent>
  </AccordionItem>
  ...
  const codeControlled = `const [value, setValue] = useState("");

<Accordion type="single" collapsible value={value} onValueChange={setValue}>
  <AccordionItem value="item-1">
    <AccordionTrigger>Painel controlado</AccordionTrigger>
    <AccordionContent>Estado externo: {value || "nenhum"}</AccordionContent>
  </AccordionItem>
</Accordion>`;

  const codeDisabled = `<AccordionItem value="item-2" disabled>
        ...
        <div className="ds-docs flex-1 min-w-0 space-y-12">
              ...
              <Accordion type="single" collapsible className="w-full max-w-lg">
                {([1, 2, 3] as const).map((i) => (
                  <AccordionItem key={i} value={`item-${i}`}>
                    ...
                    <AccordionContent>
                      <span dangerouslySetInnerHTML={{ __html: sanitizeHtml(tContent(`demonstration.labels.item${i}Content`)) }} />
                    </AccordionContent>
                  </AccordionItem>
                ))}
              </Accordion>
            ...
            <div className="border rounded-xl p-6 shadow-sm space-y-6">
              <div className="bg-muted/30 rounded-lg p-4 space-y-3">
                ...
                <ul className="list-disc pl-5 space-y-2 text-sm text-muted-foreground">
                  {[1, 2, 3, 4].map((i) => (
                    <li key={i} dangerouslySetInnerHTML={{ __html: sanitizeHtml(tContent(`usage.guidelines.item${i}`)) }} />
                  ))}
                </ul>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse text-sm">
                    ...
                    <tbody>
                      {(["trigger", "content"] as const).map((key) => (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-card border rounded-xl p-4 shadow-sm">
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-sm text-muted-foreground leading-relaxed">
                    {[1, 2, 3].map((i) => (
                      <li key={i} dangerouslySetInnerHTML={{ __html: sanitizeHtml(tContent(`usage.dont.item${i}`)) }} />
                    ))}
                  </ul>
                </div>
              </div>
              ...
              <div className="space-y-8 w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    ...
                    <div className="border border-green-200 dark:border-green-900/50 rounded-xl p-6 bg-green-50/50 dark:bg-green-950/10">
                      <Accordion type="multiple" className="w-full">
                        <AccordionItem value="g1"><AccordionTrigger>Notificações</AccordionTrigger><AccordionContent>Configurações de alerta.</AccordionContent></AccordionItem>
                        <AccordionItem value="g2"><AccordionTrigger>Privacidade</AccordionTrigger><AccordionContent>Configurações de privacidade.</AccordionContent></AccordionItem>
                      </Accordion>
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="border border-red-200 dark:border-red-900/50 rounded-xl p-6 bg-red-50/50 dark:bg-red-950/10 flex flex-col gap-1 text-sm text-muted-foreground">
                      <span>Accordion dentro de Accordion (aninhado) ←</span>
                      <span className="pl-4 text-xs italic">↳ não fazer isso</span>
                    </div>
              ...
              <div className="space-y-4 w-full">
                <div>
                  ...
                  <div className="bg-muted p-4 rounded-lg font-mono text-sm border overflow-x-auto">
                    <code className="whitespace-pre">{`import { Accordion, AccordionItem, AccordionTrigger, AccordionContent } from "@/components/ui/accordion"`}</code>
                  </div>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground mb-3">{tContent("import.individual")}</p>
                  <div className="bg-muted p-4 rounded-lg font-mono text-sm border overflow-x-auto">
                    <code className="whitespace-pre">{`import { Accordion } from "@/components/ui/accordion"\nimport { AccordionItem } from "@/components/ui/accordion"\nimport { AccordionTrigger } from "@/components/ui/accordion"\nimport { AccordionContent } from "@/components/ui/accordion"`}</code>
                  </div>
                </div>
              </div>
            </ComponentDemo>
          ...
          <section id="exemplos">
            ...
            <div className="space-y-8">
              <div className="space-y-3">
                <h3 className="text-sm font-medium">{tContent("examples.single")}</h3>
                <ComponentDemo>
                  <Accordion type="single" collapsible className="w-full max-w-lg">
                ...
                <div className="bg-muted p-4 rounded-lg font-mono text-sm border overflow-x-auto"><code className="whitespace-pre">{codeSingle}</code></div>
              </div>
              <div className="space-y-3">
                <h3 className="text-sm font-medium">{tContent("examples.multiple")}</h3>
                <ComponentDemo>
                ...
                <div className="bg-muted p-4 rounded-lg font-mono text-sm border overflow-x-auto"><code className="whitespace-pre">{codeMultiple}</code></div>
              </div>
              <div className="space-y-3">
                <h3 className="text-sm font-medium">{tContent("examples.controlled")}</h3>
                <div className="bg-muted p-4 rounded-lg font-mono text-sm border overflow-x-auto"><code className="whitespace-pre">{codeControlled}</code></div>
              </div>
              <div className="space-y-3">
                ...
                <ComponentDemo>
                  <Accordion type="single" collapsible className="w-full max-w-lg">
                    ...
                    <AccordionItem value="d-2" disabled><AccordionTrigger>Item desabilitado</AccordionTrigger><AccordionContent>Este conteúdo não é acessível.</AccordionContent></AccordionItem>
                  </Accordion>
                </ComponentDemo>
          ...
          <section id="variantes">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full">
                {(["single", "multiple", "controlled"] as const).map((mode) => (
                  <div key={mode} className="border border-border/60 rounded-xl overflow-hidden bg-card/50 flex flex-col transition-all hover:border-primary/30 hover:shadow-sm">
                    <div className="flex-1 flex items-center justify-center p-6 bg-muted/5 min-h-[140px]">
                      <Accordion type={mode === "controlled" ? "single" : mode} collapsible={mode !== "multiple" ? true : undefined} className="w-full">
                        <AccordionItem value="m1"><AccordionTrigger className="text-xs">Painel A</AccordionTrigger><AccordionContent className="text-xs">Conteúdo A.</AccordionContent></AccordionItem>
                        <AccordionItem value="m2"><AccordionTrigger className="text-xs">Painel B</AccordionTrigger><AccordionContent className="text-xs">Conteúdo B.</AccordionContent></AccordionItem>
                      </Accordion>
                    </div>
                    <div className="p-4 border-t border-border/40 bg-muted/10 space-y-1">
                      ...
                      <p className="text-xs text-muted-foreground leading-relaxed"
                         dangerouslySetInnerHTML={{ __html: sanitizeHtml(tContent(`variants.items.${mode}`)) }} />
                    </div>
                  </div>
                ))}
              </div>
              ...
              <table className="w-full border-collapse text-sm">
                ...
                <tbody>
                  <tr className="border-b border-border hover:bg-muted/5 transition-colors">
                    <td className="p-3 border-r border-border font-medium">{tContent("states.table.closed")}</td>
                    <td className="p-3 border-r border-border text-muted-foreground italic">{tContent("states.table.closedVisual")}</td>
                    <td className="p-3 text-muted-foreground">{tContent("states.table.closedTrigger")}</td>
                  </tr>
                  <tr className="border-b border-border hover:bg-muted/5 transition-colors">
                    <td className="p-3 border-r border-border font-medium">{tContent("states.table.open")}</td>
                    <td className="p-3 border-r border-border text-muted-foreground italic">{tContent("states.table.openVisual")}</td>
                    <td className="p-3 text-muted-foreground"
                        dangerouslySetInnerHTML={{ __html: sanitizeHtml(tContent("states.table.openTrigger")) }} />
                  </tr>
                  <tr className="border-b border-border hover:bg-muted/5 transition-colors">
                    <td className="p-3 border-r border-border font-medium">{tContent("states.table.focus")}</td>
                    <td className="p-3 border-r border-border text-muted-foreground italic">{tContent("states.table.focusVisual")}</td>
                    <td className="p-3 text-muted-foreground"
                        dangerouslySetInnerHTML={{ __html: sanitizeHtml(tContent("states.table.focusTrigger")) }} />
                  </tr>
                  <tr className="border-b last:border-0 hover:bg-muted/5 transition-colors">
                    <td className="p-3 border-r border-border font-medium">{tContent("states.table.disabled")}</td>
                    <td className="p-3 border-r border-border text-muted-foreground italic">{tContent("states.table.disabledVisual")}</td>
                    <td className="p-3 text-muted-foreground"
                        dangerouslySetInnerHTML={{ __html: sanitizeHtml(tContent("states.table.disabledTrigger")) }} />
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <section id="propriedades">
            ...
            <div className="space-y-8">
              ...
              {/* Root */}
              <div className="space-y-4">
                <h3 className="font-medium text-sm">{tContent("props.rootTitle")}</h3>
...
interface AccordionMultipleProps {
  ...
  className?: string
                    ...
                    <tbody>
                      {([
                        ...
                        <tr key={prop.name} className="border-b last:border-0 hover:bg-muted/5">
                          ...
                          <td className="p-3 text-muted-foreground"
                              dangerouslySetInnerHTML={{ __html: sanitizeHtml(tContent(`props.table.${prop.descKey}`)) }} />
                        </tr>
                      ))}
                    </tbody>
                  </table>
              ...
              {/* Item */}
              <div className="space-y-4">
                <h3 className="font-medium text-sm">{tContent("props.itemTitle")}</h3>
                <div className="border rounded-xl overflow-x-auto p-4 shadow-sm">
                  <table className="w-full border-collapse text-sm" style={{ margin: 0 }}>
                    <thead className="bg-muted/50 border-b text-left">
                      <tr>
                  ...
                  <tbody>
                    {[
                      ...
                      <tr key={row.token} className="border-b last:border-0 hover:bg-muted/5 transition-colors">
                        ...
                        <td className="p-3 text-muted-foreground">{tContent(`tokens.table.${row.partKey}`)}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
...
html.meu-tema {
  --border: 262 30% 82%;        /* Borda com matiz roxo */
  --ring: 262 80% 58%;          /* Focus ring roxo */
            ...
            <div className="border rounded-xl p-6 shadow-sm space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-3">
                  {(["tab", "shiftTab", "enter", "space"] as const).map((key) => (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {([
                ...
                >
                  ...
                  <p className="text-xs text-muted-foreground">{tContent(`related.${item.descKey}`)}</p>
                </div>
              ))}
            </div>
          </section>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-primary/5 border-l-4 border-primary rounded-r-lg">
                <p className="text-sm text-muted-foreground leading-relaxed"
                   dangerouslySetInnerHTML={{ __html: sanitizeHtml(tContent("notes.tip1")) }} />
              </div>
              <div className="p-4 bg-orange-500/5 border-l-4 border-orange-500 rounded-r-lg">
                <p className="text-sm text-muted-foreground leading-relaxed"
                   dangerouslySetInnerHTML={{ __html: sanitizeHtml(tContent("notes.tip2")) }} />
              </div>
              <div className="p-4 bg-blue-500/5 border-l-4 border-blue-500 rounded-r-lg">
                <p className="text-sm text-muted-foreground leading-relaxed"
                   dangerouslySetInnerHTML={{ __html: sanitizeHtml(tContent("notes.tip3")) }} />
              </div>
            </div>
          </section>
                ...
                <table className="w-full border-collapse text-sm" style={{ margin: 0 }}>
                  ...
                  <tbody>
                    {(["toggle", "pageView", "sectionViewed", "langSwitch"] as const).map((key) => (
                      <tr key={key} className="border-b last:border-0 hover:bg-muted/5">
                        <td className="p-3 border-r border-border font-mono text-primary font-bold">{tContent(`analytics.table.${key}`)}</td>
                        <td className="p-3 border-r border-border">{tContent(`analytics.table.${key}Trigger`)}</td>
                        <td className="p-3 font-mono text-muted-foreground">{tContent(`analytics.table.${key}Payload`)}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
                  ...
                  {([1, 2, 3, 4, 5, 6] as const).map((i) => (
                    <div key={i} className="flex gap-3 items-start p-4 bg-muted/10 rounded-lg border border-border/40">
                      ...
                      <span className="text-xs text-muted-foreground leading-relaxed"
                            dangerouslySetInnerHTML={{ __html: sanitizeHtml(tContent(`testes.accessibility.item${i}`)) }} />
                    </div>
                  ))}
                </div>
              </div>
